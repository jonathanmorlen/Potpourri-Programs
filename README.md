...
- A* Algorithm: OOP implementation of the [A* algorithm](https://en.wikipedia.org/wiki/A*_search_algorithm). Computes the shortest distance from a starting coordinate to an ending coordinate in a rectangular grid of 1's and 0's, where a 0 is traversable and a 1 is not. Prints the grid with the solution path as x's, the coordinates of the path elements, and the length of the path.
